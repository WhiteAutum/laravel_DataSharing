                        ...
                        <form class="form-horizontal" id="default">
                            <fieldset title="Step1" class="step">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" placeholder="Task Name" ng-model="taskName"
                                               ng-change="checkProvideTaskNameLegal(taskName)">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <!-- <textarea type="text" cols="60" rows="5" class="form-control" placeholder="Introduction"
                                ...
                                <div class="form-group">
                                    <div class="col-lg-offset-3 col-lg-3">
                                        <button type="submit" class="btn btn-danger col-lg-12"
                                                ng-click="provideTask(selectedAccount.address, password, taskName, introduction, selectedTool,selectedPurpose)">
                                            Provide
                                            Data
                                        </button>
                                    </div>
