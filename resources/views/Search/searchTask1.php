                            ...
                            <fieldset class="step">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-offset-2 col-lg-10">
                                        <button type="submit" class="btn btn-danger col-lg-2" ng-click="searchTaskByName(taskName)">Search
                                        </button>
                                    </div>
                                </div>
                        ...
                        <form class="form-horizontal">
                            <fieldset class="step">
                                ...
                                <div>
                                    <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-danger col-lg-2"
                                                ng-click="searchTaskByType(tool_type.key, selectedTool)">Search By Tool
                                        </button>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-danger col-lg-2"
                                                ng-click="searchTaskByType(purpose_type.key, selectedPurpose)">Search By Purpose
                                        </button>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-offset-2 col-lg-10">
                                        <button type="submit" class="btn btn-danger col-lg-2"
                                                ng-click="searchTaskByType(type_key, type_value)">Search
                                        </button>
                                    </div>
                                </div>
                                <table class="table table-striped border-top">
                                    ...
                                    <tbody>
                                    <tr class="odd gradeX" ng-repeat="taskSet in taskSets">
                                        <td><input type="checkbox" class="checkboxes" value="1"/></td>
                                        <td>{{taskSet.taskName}}</td>
                                        <td class="hidden-phone">
                                            <p ng-repeat="type in taskSet.types">{{type.key}}=>{{type.value}}</p>
                                        </td>
                                        <td class="hidden-phone">{{taskSet.introduction}}</td>
                                        <td class="hidden-phone">{{taskSet.provider}}</td>
                                        <td class="hidden-phone">{{taskSet.finishStatus}}</td>
                                    </tr>
                                    </tbody>
                                </table>
